...
import com.alura.aluraHotel.controller.HuespedesController;
import com.alura.aluraHotel.controller.ReservaController;
...
public class RegistroHuesped extends JFrame {
	...
	ReservasView ventanaReservas = new ReservasView();
...
//        txtNreserva.setText(ventanaReservas.getReserva().getIdReserva().toString());
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	    ...
	    private void guardar(){
	    	Date fechaNacimiento = Date.valueOf(ConvertirFecha.convertirDateALocalDate(txtFechaN.getDate()));
	    ...
	    /**
	     * Obtner la ID de reserva
	     */
	    private void maxId(){
	    	maxId = reservaController.obtenerId();
	    	String x = String.valueOf(maxId);
	    	System.out.println(x);
	    	txtNreserva.setText(x);
	    }
}
